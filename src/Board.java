public class Board {
    ...
    public static void initBoard(){
        ...
        blackPieceRow[0] = new Rook(0, 7, 8, 8);
        blackPieceRow[1] = new Knight(1, 7, 3, 3);
        blackPieceRow[2] = new Bishop(2, 7, 8, 8);
        blackPieceRow[3] = new Queen(3, 7, 8, 8);
        blackPieceRow[4] = new King(4, 7, 1, 1);
        King.kingcoords[0] = 4;
        King.kingcoords[1] = 7;
        blackPieceRow[5] = new Bishop(5, 7, 8, 8);
        blackPieceRow[6] = new Knight(6, 7, 3, 3);
        blackPieceRow[7] = new Rook(7, 7, 8, 8);
        boardSpaces[0] = blackPieceRow;

        Piece [] blackPawnRow = new Piece[8];
        for(int r = 0; r < 8; r++){
            blackPawnRow[r] = new Pawn(2, r, 1, 2);
        }
        ...
        for(int r = 0; r < 8; r++){
            whitePawnRow[r] = new Pawn(6, r, 1, 2);
        }
        boardSpaces[6] = whitePawnRow;

        Piece [] whitePieceRow = new Piece[8];
        whitePieceRow[0] = new Rook(0, 0, 8, 8);
        whitePieceRow[1] = new Knight(1, 0, 3, 3);
        whitePieceRow[2] = new Bishop(2, 0, 8, 8);
        whitePieceRow[3] = new Queen(3, 0, 8, 8);
        whitePieceRow[4] = new King(4, 0, 1, 1);
        King.kingcoords[2] = 4;
        King.kingcoords[3] = 0;
        whitePieceRow[5] = new Bishop(5, 0, 8, 8);
        whitePieceRow[6] = new Knight(6, 0, 3, 3);
        whitePieceRow[7] = new Rook(7, 0, 8, 8);
